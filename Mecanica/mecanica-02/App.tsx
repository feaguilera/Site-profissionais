...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen selection:bg-[#2563EB] selection:text-white">
      {/* Header */}
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#0B1120]/95 backdrop-blur-md shadow-2xl py-3 border-b border-white/5' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => scrollToSection('home')}>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-bold text-[#60A5FA] uppercase tracking-[0.2em] -mt-1">Engenharia Automotiva</span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <button 
              ...
              className="bg-[#2563EB] text-white px-6 py-2.5 rounded-md text-[11px] font-black uppercase tracking-widest btn-performance flex items-center gap-2"
            >
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="lg:hidden fixed inset-0 bg-[#0B1120] z-50 flex flex-col p-8 animate-in slide-in-from-right">
            ...
            <div className="flex flex-col gap-6">
              ...
              <button 
                onClick={() => window.open('https://wa.me/5511999999999', '_blank')}
                className="bg-[#2563EB] text-white py-5 rounded-lg font-bold mt-6 uppercase tracking-widest text-sm flex justify-center items-center gap-3"
              >
      ...
      <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-[#2563EB]/5 -skew-x-12 translate-x-1/4 pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="z-10 animate-in fade-in duration-700">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight uppercase italic tracking-tighter">
              Mecânica de <br />
              <span className="text-[#2563EB]">Confiança</span> & Precisão.
            </h1>
            <p className="text-lg text-slate-400 mb-10 leading-relaxed max-w-lg">
              Evite gastos desnecessários. Oferecemos diagnóstico digital completo, peças originais com 1 ano de garantia e transparência total em cada etapa do serviço.
            </p>
            <div className="flex flex-col sm:flex-row gap-5">
              <button 
                onClick={() => window.open('https://wa.me/5511999999999', '_blank')}
                className="bg-[#2563EB] text-white px-10 py-5 rounded-md font-black text-xs tracking-widest uppercase btn-performance shadow-2xl flex items-center justify-center gap-3"
              >
                Solicitar Orçamento <ArrowRight size={18} />
              </button>
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-2 text-white font-bold text-sm">
                  <Clock size={16} className="text-[#2563EB]" /> Check-up em 2 horas
                </div>
          ...
          <div className="relative hidden lg:block animate-in slide-in-from-bottom-10 duration-1000">
            <div className="rounded-2xl overflow-hidden border-4 border-[#1E293B] shadow-industrial relative group">
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-[#0B1120]/90 backdrop-blur-md p-6 rounded-xl border border-white/10">
      ...
      {/* Brands Bar */}
      <div className="bg-[#111827] py-10 border-y border-white/5">
      ...
      {/* Benefits Section */}
      <section id="diferenciais" className="py-24 bg-[#0B1120]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            {BENEFITS.map((benefit, idx) => (
              <div key={idx} className="bg-[#1E293B] p-8 rounded-xl border border-white/5 hover:border-[#2563EB]/40 transition-all">
                <div className="text-[#2563EB] mb-6">{benefit.icon}</div>
      ...
      {/* Process Section */}
      <section id="processo" className="py-24 bg-[#111827] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {PROCESS.map((p, idx) => (
              <div key={idx} className="relative p-8 rounded-xl bg-[#0B1120]/50 border border-white/5 flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-[#2563EB] flex items-center justify-center text-white mb-6 shadow-xl shadow-[#2563EB]/10">
                  {p.icon}
                </div>
      ...
      {/* Services Section */}
      <section id="servicos" className="py-32 bg-[#0B1120]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-xl">
              <span className="text-[#2563EB] text-[10px] font-black tracking-[0.3em] uppercase mb-4 block">Precisão Mecânica</span>
            ...
            <button 
              onClick={() => window.open('https://wa.me/5511999999999', '_blank')}
              className="text-white bg-[#1E293B] px-8 py-4 rounded-md font-black text-[10px] uppercase tracking-widest border border-white/10 hover:bg-[#2563EB] transition-all"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {SERVICES.map((s) => (
              <div key={s.id} className="bg-[#1E293B] p-8 rounded-2xl border border-white/5 hover:border-[#2563EB]/30 transition-all group">
                <div className="flex justify-between items-start mb-10">
                  <div className="bg-[#0B1120] p-4 rounded-xl text-[#2563EB] group-hover:bg-[#2563EB] group-hover:text-white transition-all">
                    {s.icon || <Settings size={24} />}
                  </div>
                  {s.tag && <span className="bg-[#2563EB]/10 text-[#2563EB] px-3 py-1 rounded text-[9px] font-black uppercase tracking-widest">{s.tag}</span>}
                </div>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-white/5">
                  ...
                  <button className="text-[#2563EB] group-hover:translate-x-2 transition-transform">
                    <ArrowRight size={20} />
                  </button>
                </div>
              </div>
      ...
      <div className="bg-[#2563EB] py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button 
            ...
            className="bg-[#0B1120] text-white px-10 py-4 rounded-md font-black uppercase text-xs tracking-widest flex items-center gap-3 shadow-xl hover:bg-white hover:text-[#0B1120] transition-all"
          >
      ...
      {/* Location Section */}
      <section id="localizacao" className="py-32 bg-[#111827]">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <MapPin className="text-[#2563EB] shrink-0" size={24} />
                <div>
              ...
              <div className="pt-8">
                <button className="bg-white/5 border border-white/10 text-white px-8 py-4 rounded-md font-black text-[10px] uppercase tracking-[0.3em] hover:bg-[#2563EB] hover:border-[#2563EB] transition-all flex items-center gap-3">
                  Como Chegar (Google Maps) <ArrowRight size={14} />
                </button>
              </div>
            </div>
          </div>
          <div className="h-[400px] bg-slate-800 rounded-2xl overflow-hidden relative border-4 border-[#0B1120] shadow-industrial">
            <div className="absolute inset-0 bg-[#0B1120]/20"></div>
            <img 
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-[#2563EB] p-4 rounded-full shadow-2xl animate-bounce">
      ...
      {/* Social Proof */}
      <section id="depoimentos" className="py-32 bg-[#0B1120]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="bg-[#1E293B] p-10 rounded-2xl border border-white/5 text-left relative">
                <div className="flex text-[#2563EB] mb-6">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-32 bg-[#111827]">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {FAQ.map((item, idx) => (
              <div key={idx} className="bg-[#0B1120] rounded-xl border border-white/5">
                <button 
                  onClick={() => setActiveFaq(activeFaq === idx ? null : idx)}
                  className="w-full p-6 text-left flex justify-between items-center group"
                >
                  <span className="text-white font-bold tracking-tight text-sm group-hover:text-[#2563EB] transition-colors">{item.question}</span>
                  <ChevronDown className={`text-[#2563EB] transition-transform duration-300 ${activeFaq === idx ? 'rotate-180' : ''}`} size={20} />
                </button>
      ...
      {/* Final CTA */}
      <section className="py-40 bg-[#2563EB] relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
          <Settings size={800} className="animate-spin-slow text-white" />
        </div>
        <div className="max-w-3xl mx-auto px-6 relative z-10 text-center">
          <h2 className="text-6xl md:text-8xl font-black text-white mb-10 italic uppercase tracking-tighter leading-none">Mantenha seu <br /> carro novo.</h2>
          <p className="text-white font-bold uppercase tracking-[0.3em] mb-12 text-sm opacity-80">Orçamento digital sem custos hoje.</p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button 
              onClick={() => window.open('https://wa.me/5511999999999', '_blank')}
              className="bg-[#0B1120] text-white px-12 py-6 rounded-md font-black text-xs tracking-widest uppercase shadow-2xl flex items-center justify-center gap-3 hover:bg-white hover:text-[#0B1120] transition-all"
            >
              <MessageCircle size={20} /> Chamar no WhatsApp
            </button>
            <button 
               onClick={() => scrollToSection('localizacao')}
               className="bg-transparent border-2 border-white text-white px-12 py-6 rounded-md font-black text-xs tracking-widest uppercase flex items-center justify-center gap-3 hover:bg-white hover:text-[#0B1120] transition-all"
            >
              Ver Localização
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#0B1120] pt-32 pb-16 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
            <div className="col-span-1">
              ...
              <p className="text-slate-500 text-[9px] uppercase font-black tracking-widest leading-loose mb-10">
                Engenharia, Transparência e <br />Tecnologia Automotiva.
              </p>
              <div className="flex gap-5">
                <a href="#" className="w-10 h-10 rounded-lg bg-[#111827] flex items-center justify-center text-slate-400 hover:text-[#2563EB] transition-all"><Instagram size={20} /></a>
                <a href="#" className="w-10 h-10 rounded-lg bg-[#111827] flex items-center justify-center text-slate-400 hover:text-[#2563EB] transition-all"><MessageCircle size={20} /></a>
              </div>
            </div>
            ...
            {[
              ...
              <div key={idx}>
                <h4 className="text-[#2563EB] mb-8 text-[10px] font-black uppercase tracking-[0.4em]">{col.title}</h4>
      ...
      <button 
        onClick={() => window.open('https://wa.me/5511999999999', '_blank')}
        className="fixed bottom-10 right-10 bg-[#25D366] text-white p-5 rounded-full shadow-2xl hover:scale-110 transition-all z-50 flex items-center gap-3"
      >
